...
My work on privacy has appeared on ICML, NeurIPS, IJCAI, AISTATS (to appear) and Nature. My Google scholar profile is [[https://scholar.google.com/citations?hl=en&user=crI3PxsAAAAJ][here]]. My advisor is [[https://engineering.virginia.edu/faculty/anil-vullikanti][Dr. Anil Vullikanti]].
...
** Selected publications: (First-authored or alphabetical order papers)
  ...
  - Computing epidemic metrics with edge differential privacy
	...
	/*(α-β)* George Li, *Dung Nguyen*, and Anil Vullikanti./ AISTATS 2024  (to appear)
